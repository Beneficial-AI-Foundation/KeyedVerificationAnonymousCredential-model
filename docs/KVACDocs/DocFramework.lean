...
:::definition "kvac_anonymity" (lean := "KVAC.Framework.AnonSimulator, KVAC.Framework.AnonQuery, KVAC.Framework.AnonPresentSpec, KVAC.Framework.AnonComp, KVAC.Framework.anonPresentImpl, KVAC.Framework.anonROImpl, KVAC.Framework.AnonDistSpec, KVAC.Framework.AnonIssuer, KVAC.Framework.AnonDistinguisher, KVAC.Framework.anonIssuance, KVAC.Framework.anonGameReal, KVAC.Framework.anonGameSim, KVAC.Framework.AnonAdv, KVAC.Framework.AnonInstance, KVAC.Framework.AnonInstance.adv, KVAC.Framework.NonemptyMsg, KVAC.Framework.Anonymous, KVAC.Framework.StatisticallyAnonymous, KVAC.Framework.EverlastingForwardAnonymous, KVAC.Framework.AnonymousPoly") (parent := "framework_anonymity") (tags := "paper, O24 Def 4.4") (effort := "medium") (priority := "high")
