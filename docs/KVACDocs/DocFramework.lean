...
:::definition "kvac_extractability" (lean := "KVAC.Framework.Extractable, KVAC.Framework.PolyBounded, KVAC.Framework.extSecurityGameSched, KVAC.Framework.ExtractablePoly") (parent := "framework_extract") (tags := "paper, O24 Def 4.5") (effort := "medium") (priority := "high")
